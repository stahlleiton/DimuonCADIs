...
//=========  (Sat Feb  4 22:21:46 2017) by ROOT version5.34/36
   ...
   gre->SetPoint(0,0.64,0.282);
   gre->SetPointError(0,0.02,0.023);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,0.616,0.664);
   Graph_Graph1->SetMinimum(0.2544);
   Graph_Graph1->SetMaximum(0.3096);
   ...
   gre->SetFillColor(ci);
   gre->SetMarkerStyle(20);
   gre->SetPoint(0,0.05,0.13);
   gre->SetPointError(0,0.02,0.02);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,0.026,0.074);
   Graph_Graph2->SetMinimum(0.106);
   Graph_Graph2->SetMaximum(0.154);
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,0.54,1.74);
   Graph_Graph3->SetMinimum(0.27);
   Graph_Graph3->SetMaximum(0.294);
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Graph",100,0,1.15);
   Graph_Graph4->SetMinimum(0.082);
   Graph_Graph4->SetMaximum(0.178);
   ...
   TH1F *Graph_Graph5 = new TH1F("Graph_Graph5","Graph",100,0.54,1.74);
   Graph_Graph5->SetMinimum(0.27);
   Graph_Graph5->SetMaximum(0.294);
   ...
   TH1F *Graph_Graph6 = new TH1F("Graph_Graph6","Graph",100,0,1.15);
   Graph_Graph6->SetMinimum(0.082);
   Graph_Graph6->SetMaximum(0.178);
   ...
   TLegend *leg = new TLegend(0.2,0.58,0.7,0.785,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("NULL","Prompt charmonia ","h");
   ...
   entry=leg->AddEntry("Graph2","J/#psi       (arXiv:1610.00613)","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry=leg->AddEntry("Graph2","    p_{T}#in [6.5,30] GeV/c, |y| < 2.4, Cent. 0-5%","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph3","#psi(2S)   (PRL 113, 2014)","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(1.2);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph3","    p_{T}#in [6.5,30] GeV/c, |y| < 1.6","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   TLatex *   tex = new TLatex(0.05,0.17,"#psi(2S)");
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.67,0.32,"J/#psi");
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   line->SetLineWidth(3);
   line->Draw();
   TArrow *arrow = new TArrow(0.2,0.145,0.2,0.03,0.015,"|>");
   ...
   leg = new TLegend(0.2,0.38,0.7,0.58,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextSize(0.035);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   entry=leg->AddEntry("NULL","Bottomonia","h");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph8","#varUpsilon(1S)","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph9","#varUpsilon(2S)","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetTextFont(42);
   leg->Draw();
      tex = new TLatex(0.94,0.4,"#varUpsilon(1S)");
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.16,"#varUpsilon(2S)");
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.22,0.16,"#varUpsilon(3S)");
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.08,1.1,"PbPb #sqrt{s_{NN}} = 2.76 TeV");
   tex->SetLineWidth(2);
   tex->Draw();
