...
{            
  ...
  else if (iPeriod==12001000)
  {
    // lumiText += lumi_PbPbXX;
    //lumiText += ", ";
    // lumiText += lumi_ppXX;
    lumiText2 += " PbPb #sqrt{s_{NN}} = 2.76 TeV";
  }
  else if (iPeriod==12002000)
  {
    // lumiText += lumi_PbPbXX;
    //lumiText += ", ";
    // lumiText += lumi_ppXX;
    lumiText2 += " PbPb, pp #sqrt{s_{NN}} = 2.76 TeV";
  }
  else if (iPeriod==12003000)
  {
    // lumiText += lumi_PbPbXX;
    //lumiText += ", ";
    // lumiText += lumi_ppXX;
    lumiText2 += " pp, PbPb #sqrt{s_{NN}} = 2.76 TeV";
  }
  cout << lumiText << endl;
