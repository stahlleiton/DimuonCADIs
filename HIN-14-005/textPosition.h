...
double ltxText_yUp     = 0.75;
double ltxText_xUp     = 0.56;

//--- makeRaa_cent.C
// for kinematic regions, 2D plots
double ltxText_xDown   = 0.2;
...
double legRaaPt_xHighStart = 0.55;
double legRaaPt_xHighEnd   = 0.75;

double ltxCentOnly_x = 0.65;
double ltxCentOnly_y = 0.82;


// ------- comparison entrySize
double entrySize = 0.035;
double ltxSetTextSize3 = 0.04;
