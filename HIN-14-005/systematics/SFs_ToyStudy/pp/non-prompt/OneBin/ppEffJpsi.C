...
void ppEffJpsi__idx_()   
{
  ...
  for(int iCat_ = 6; iCat_ < 7; iCat_++){
    ...
    //double minRap = 0.0;double maxRap = 2.4;double minPt = 10.0;double maxPt = 30.0;
    //double minRap = 1.6;double maxRap = 2.4;double minPt = 3.0;double maxPt = 30.0;
    //double minRap = 1.6;double maxRap = 2.4;double minPt = 3.0;double maxPt = 6.5;
    double minRap = 0.0;double maxRap = 2.4;double minPt = 6.5;double maxPt = 30.0;
