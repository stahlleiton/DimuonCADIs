...
void mergeEff(int iCat_ = 0) {
  ...
  for(int in = 0; in < nBins; in++){
    if(iCat_ == 2) hDis[in] = new TH1F(Form("hDis_%d",in),"",200,0.15,0.65); // cent
    if(iCat_ == 1) hDis[in] = new TH1F(Form("hDis_%d",in),"",200,0.15,0.65); // pT
    if(iCat_ == 0) hDis[in] = new TH1F(Form("hDis_%d",in),"",200,0.15,0.65); // pT
    hDis[in]->Sumw2();
