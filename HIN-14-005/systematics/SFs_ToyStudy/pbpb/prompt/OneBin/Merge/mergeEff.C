...
void mergeEff(int iCat_ = 0) {
  ...
  if(iCat_ == 0) c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_10_30.png");c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_10_30.pdf");
  if(iCat_ == 1) c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_6.5_30.png");c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_6.5_30.pdf");
  if(iCat_ == 2) c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_30.png");c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_30.pdf");
  if(iCat_ == 3) c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_6.5.png");c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_6.5.pdf");
  if(iCat_ == 4) c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_6.5_30.0.png");c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_6.5_30.0.pdf");
  if(iCat_ == 5) c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_5.5.png");c1->SaveAs("plot_pbpb_eff_dis_y_1.6_2.4_pT_3.0_5.5.pdf");
  if(iCat_ == 6) c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_6.5_8.5.png");c1->SaveAs("plot_pbpb_eff_dis_y_0.0_2.4_pT_6.5_8.5.pdf");
