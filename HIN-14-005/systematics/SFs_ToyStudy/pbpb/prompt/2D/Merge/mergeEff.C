...
void mergeEff(int iCat_ = 0) {
  ...
  for(int in = 0; in < nBin; in++){
    ...
    hDis[in] = new TH1F(Form("hDis_%d",in),"",160,0.00,0.80); // low pt
    hDis[in]->Sumw2();
  ...
  if(iCat_==0) {c1->SaveAs("plot_pbpb_eff_dis_y1.png");c1->SaveAs("plot_pbpb_eff_dis_y1.pdf");}
  if(iCat_==1) {c1->SaveAs("plot_pbpb_eff_dis_y2.png");c1->SaveAs("plot_pbpb_eff_dis_y2.pdf");}
  if(iCat_==2) {c1->SaveAs("plot_pbpb_eff_dis_y3.png");c1->SaveAs("plot_pbpb_eff_dis_y3.pdf");}
  if(iCat_==3) {c1->SaveAs("plot_pbpb_eff_dis_y4.png");c1->SaveAs("plot_pbpb_eff_dis_y4.pdf");}
  if(iCat_==4) {c1->SaveAs("plot_pbpb_eff_dis_lowpt.png");c1->SaveAs("plot_pbpb_eff_dis_lowpt.pdf");}
