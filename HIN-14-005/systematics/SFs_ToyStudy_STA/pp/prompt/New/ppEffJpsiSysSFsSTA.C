...
// This is macro for systematics study for Scale Factors  in pp
// For STA systematics
// Editor : Dong Ho Moon
#ifndef __CINT__
#endif
...
TF1 *tnpSF1 = new TF1("tnpSF1","(0.9452*TMath::Erf((x-1.9895)/1.6646))/(0.9547*TMath::Erf((x-1.7776)/2.0497))",0.0,30.0);
TF1 *tnpSF2 = new TF1("tnpSF2","(0.9296*TMath::Erf((x-1.8082)/1.4939))/(0.9150*TMath::Erf((x-1.8502)/1.6651))",0.0,30.0);
TF1 *tnpSF3 = new TF1("tnpSF3","(0.8808*TMath::Erf((x-0.8275)/2.6569))/(0.8721*TMath::Erf((x-1.1449)/2.5504))",0.0,30.0);
TF1 *tnpSF4 = new TF1("tnpSF4","(0.7180*TMath::Erf((x-0.8578)/0.8700))/(0.6137*TMath::Erf((x-1.0202)/1.0729))",0.0,30.0);
