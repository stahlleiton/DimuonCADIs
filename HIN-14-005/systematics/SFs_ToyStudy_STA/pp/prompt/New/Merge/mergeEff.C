...
void mergeEff(int iCat_ = 0) {
  ...
  if(iCat_ == 0) {c1->SaveAs("plot_pp_eff_STA_dis_pt.png");c1->SaveAs("plot_pp_eff_STA_dis_pt.pdf");}
  if(iCat_ == 1) {c1->SaveAs("plot_pp_eff_STA_dis_rap.png");c1->SaveAs("plot_pp_eff_STA_dis_rap.pdf");}
