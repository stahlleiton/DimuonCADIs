...
void mergeEff(int iCat_ = 0) {
  ...
  for(int in = 0; in < nBin; in++){
    if(iCat_ == 0) hDis[in] = new TH1F(Form("hDis_%d",in),"",160,0.25,0.85); // pT
    if(!((iCat_ == 1) || (iCat_ == 4) || (iCat_ == 6) || (iCat_ == 0))) hDis[in] = new TH1F(Form("hDis_%d",in),"",160,0.05,0.45); // cent
    if((iCat_ == 1) || (iCat_ == 4) || (iCat_ == 6) ) hDis[in] = new TH1F(Form("hDis_%d",in),"",160,0.2,0.6); // pT
  ...
  if(iCat_ == 0) sprintf(OutTextFile,"pbpb_prompt_y_0.0_2.4_pT_10_30.tex");
  if(iCat_ == 1) sprintf(OutTextFile,"pbpb_prompt_y_0.0_2.4_pT_6.5_30.tex");
  if(iCat_ == 2) sprintf(OutTextFile,"pbpb_prompt_y_1.6_2.4_pT_3.0_30.tex");
  if(iCat_ == 3) sprintf(OutTextFile,"pbpb_prompt_y_1.6_2.4_pT_3.0_6.5.tex");
  if(iCat_ == 4) sprintf(OutTextFile,"pbpb_prompt_y_1.6_2.4_pT_6.5_30.0.tex");
  if(iCat_ == 5) sprintf(OutTextFile,"pbpb_prompt_y_1.6_2.4_pT_3.0_5.5.tex");
  if(iCat_ == 6) sprintf(OutTextFile,"pbpb_prompt_y_0.0_2.4_pT_6.5_8.5.tex");
  ...
  if(iCat_ == 0) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_10_30.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_10_30.pdf");
  if(iCat_ == 1) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_6.5_30.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_6.5_30.pdf");
  if(iCat_ == 2) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_30.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_30.pdf");
  if(iCat_ == 3) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_6.5.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_6.5.pdf");
  if(iCat_ == 4) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_6.5_30.0.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_6.5_30.0.pdf");
  if(iCat_ == 5) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_5.5.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_1.6_2.4_pT_3.0_5.5.pdf");
  if(iCat_ == 6) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_6.5_8.5.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_y_0.0_2.4_pT_6.5_8.5.pdf");
