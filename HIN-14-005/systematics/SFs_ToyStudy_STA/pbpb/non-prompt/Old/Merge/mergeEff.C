...
void mergeEff(int iCat_ = 0) {
  ...
  for(int in = 0; in < nBins; in++){
    if(iCat_ == 2) hDis[in] = new TH1F(Form("hDis_%d",in),"",120,0.15,0.55); // cent
    if(iCat_ != 2) hDis[in] = new TH1F(Form("hDis_%d",in),"",120,0.15,0.85); // pT
    hDis[in]->Sumw2();
  ...
  if(iCat_ == 0) c1->SaveAs("plot_pbpb_eff_STA_npr_dis_cent.png");c1->SaveAs("plot_pbpb_eff_STA_npr_dis_cent.pdf");
  if(iCat_ == 1) c2->SaveAs("plot_pbpb_eff_STA_npr_dis_pt.png");c2->SaveAs("plot_pbpb_eff_STA_npr_dis_pt.pdf");
  if(iCat_ == 2) c2->SaveAs("plot_pbpb_eff_STA_npr_dis_rap.png");c2->SaveAs("plot_pbpb_eff_STA_npr_dis_rap.pdf");
