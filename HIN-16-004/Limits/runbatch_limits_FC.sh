...
echo root -l -b -q runLimit_RaaNS_Workspace_FC.C+'("'${it}'", "RFrac2Svs1S_PbPbvsPP", "simPdf", "workspace", "dOS_DATA", "'${ACTag}'", '${CL}', '${poimin}', '${poimax}')'
root -l -b -q runLimit_RaaNS_Workspace_FC.C+'("'${it}'", "RFrac2Svs1S_PbPbvsPP", "simPdf", "workspace", "dOS_DATA", "'${ACTag}'", '${CL}', '${poimin}', '${poimax}')'
