...
echo root -l -b -q runLimit_RaaNS_Workspace.C+'("'${it}'", "RFrac2Svs1S_PbPbvsPP_P", "simPdf", "workspace", "dOS_DATA", "'${ACTag}'", '${CL}', '${calculatorType}', '${testStatType}', '${useCLs}', '${poival}', '${rndseed}')'
time root -l -b -q runLimit_RaaNS_Workspace.C+'("'${it}'", "RFrac2Svs1S_PbPbvsPP_P", "simPdf", "workspace", "dOS_DATA", "'${ACTag}'", '${CL}', '${calculatorType}', '${testStatType}', '${useCLs}', '${poival}', '${rndseed}')'
