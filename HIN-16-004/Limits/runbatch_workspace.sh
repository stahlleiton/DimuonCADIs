...
echo root -l -b -q combinedWorkspace.C+'("'${it_PbPb}'", "'${it_PP}'", "combined_PbPbPP_workspace_'${binName}'.root", '${systvalMult}', '${systValAdd2R}', '${systValAddRPP}', '${systValAddRPbPb}', "'${ACTag}'", '${nCPU}')'
time root -l -b -q combinedWorkspace.C+'("'${it_PbPb}'", "'${it_PP}'", "combined_PbPbPP_workspace_'${binName}'.root", '${systvalMult}', '${systValAdd2R}', '${systValAddRPP}', '${systValAddRPbPb}', "'${ACTag}'", '${nCPU}')'
