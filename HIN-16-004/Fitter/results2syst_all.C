...
void results2syst_all(bool testChi2 = true, bool is16004 = false)
{
  ...
  results2syst(workdir_nominal.Data(),sysFileName.Data(),"ctau bkg.",1,"PbPb",true,"N_Jpsi",testChi2,is16004);
  cout << endl;
  cout << "For N_Jpsi in pp: " << endl;
  sysFileName = Form("syst_%s_NJpsi_PP_ctauBkg.csv",app.Data());
  results2syst(workdir_nominal.Data(),sysFileName.Data(),"ctau bkg.",1,"PP",true,"N_Jpsi",testChi2,is16004);
  cout << endl;
  
  //b fraction
  cout << "For b fraction in Pbpb: " << endl;
  sysFileName = Form("syst_%s_BJpsi_PbPb_ctauBkg.csv",app.Data());
  results2syst(workdir_nominal.Data(),sysFileName.Data(),"ctau bkg.",1,"PbPb",true,"b_Jpsi",testChi2,is16004);
  cout << endl;
  cout << "For b fraction in pp: " << endl;
  sysFileName = Form("syst_%s_BJpsi_PP_ctauBkg.csv",app.Data());
  results2syst(workdir_nominal.Data(),sysFileName.Data(),"ctau bkg.",1,"PP",true,"b_Jpsi",testChi2,is16004);
  cout << endl;
