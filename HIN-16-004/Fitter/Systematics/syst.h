...
map<anabin, syst> readSyst_all(const char* collSystem="", const char* poiname="NJpsi", const char* prependPath="", bool doPrintTex=false, const char* texName="Systematics/systs.tex");
