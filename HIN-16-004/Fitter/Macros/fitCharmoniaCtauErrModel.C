...
void setCtauErrGlobalParameterRange(RooWorkspace& myws, map<string, string>& parIni, struct KinCuts& cut, string label);
                               ...
                               )  
{
  ...
  setCtauErrGlobalParameterRange(myws, parIni, cut, label);
