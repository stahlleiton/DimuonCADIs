                            ...
                            )  
{
  ...
  string dsNameCut = dsName2Fit+"_CTAUCUT";
  ...
  if (importDS) { 
    ...
    RooDataSet* dataToFit = (RooDataSet*)(myws.data(dsName2Fit.c_str())->reduce(parIni["CtauRange_Cut"].c_str()))->Clone((dsName2Fit+"_CTAUCUT").c_str());
