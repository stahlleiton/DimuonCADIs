...
void plotEffs_vars() {
   TFile *fjpsi_pp = new TFile("files_100vars/histos_jpsi_pp.root");
   TFile *fpsi2s_pp = new TFile("files_100vars/histos_psi2s_pp.root");
   // TFile *fnpjpsi_pp = new TFile("files_100vars/histos_npjpsi_pp.root");
   TFile *fjpsi_pbpb = new TFile("files_100vars/histos_jpsi_pbpb.root");
   TFile *fpsi2s_pbpb = new TFile("files_100vars/histos_psi2s_pbpb.root");
   // TFile *fnpjpsi_pbpb = new TFile("files_100vars/histos_npjpsi_pbpb.root");

   ofstream file_nocut("files_100vars/syst_PbPb_eff_MCstat_nocut.csv");
   ofstream file_ctaucut("files_100vars/syst_PbPb_eff_MCstat_ctaucut.csv");
   ofstream file_ctauptdepcut("files_100vars/syst_PbPb_eff_MCstat_ctauptdepcut.csv");
   ...
   for (int icoll=0; icoll<2; icoll++) {
      ...
      TString name = "files_100vars/histos_jpsi_" + colltag + ".root";
      TFile *fjpsi = new TFile(name);
      name = "files_100vars/histos_psi2s_" + colltag + ".root";
      ...
      for (int idep=0; idep<3; idep++) { // idep=2 -> integrated
         ...
         for (int irap=0; irap<2; irap++) {
            ...
            cname = "files_100vars/" + effname + colltag + "_" + deptag + "_" + raptag + "_" + cuttag;
            ...
            cname = "files_100vars/simpleratio_" + deptag + "_" + raptag + "_" + cuttag;
            texname = cname + ".tex";
            ...
            cname = "files_100vars/doubleratio_" + deptag + "_" + raptag + "_" + cuttag;
            texname = cname + ".tex";
...
TProfile* SingleRatio(TObjArray *anum2, TObjArray *aden2, TObjArray *anum1, TObjArray *aden1, TString tag) {
   ...
   for (int i=1; i<4.*nvars; i++) {
      ...
      hnum1->Sumw2(true);
      hden1->Sumw2(true);
      hnum2->Divide(hnum2,hden2,1,1,"B");
      hnum1->Divide(hnum1,hden1,1,1,"B");
      hnum2->Divide(hnum1);
      fillTProf(tprof,hnum2);
      if (doint) {
         delete hnum2;
         delete hden2;
         delete hnum1;
...
TProfile* DoubleRatio(TObjArray *anum2pbpb, TObjArray *aden2pbpb, TObjArray *anum1pbpb, TObjArray *aden1pbpb, TObjArray *anum2pp, TObjArray *aden2pp, TObjArray *anum1pp, TObjArray *aden1pp, TString tag) {
   ...
   for (int i=1; i<8.*nvars; i++) {
      ...
      hnum2pbpb->Divide(hnum2pbpb,hden2pbpb,1,1,"B");
      hnum1pbpb->Divide(hnum1pbpb,hden1pbpb,1,1,"B");
      hnum2pbpb->Divide(hnum1pbpb);
      hnum2pp->Sumw2(true);
      hden2pp->Sumw2(true);
      hnum1pp->Sumw2(true);
      hden1pp->Sumw2(true);
      hnum2pp->Divide(hnum2pp,hden2pp,1,1,"B");
      hnum1pp->Divide(hnum1pp,hden1pp,1,1,"B");
      hnum2pp->Divide(hnum1pp);
      hnum2pbpb->Divide(hnum2pp);
      fillTProf(tprof,hnum2pbpb);
      if (doint) {
         delete hnum2pbpb;
         delete hden2pbpb;
         delete hnum1pbpb;
