...
// Fri Jun 17 15:23:04 2016 by ROOT version 6.07/07
// from TTree myTree/My TTree of dimuons
// found on file: root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/Data2015/PbPb502TeV/TTrees/PromptAOD/OniaTree_HIOniaL1DoubleMu0_HIRun2015-PromptReco-v1_Run_262620_263757.root
//////////////////////////////////////////////////////////

#ifndef oniaEff_data_h
#define oniaEff_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Reco_QQ_size;
   Int_t           Reco_QQ_type[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_sign[30];   //[Reco_QQ_size]
   TClonesArray    *Reco_QQ_4mom;
   TClonesArray    *Reco_QQ_mupl_4mom;
   TClonesArray    *Reco_QQ_mumi_4mom;
   ULong64_t       Reco_QQ_trig[30];   //[Reco_QQ_size]
   ULong64_t       Reco_QQ_mupl_trig[30];   //[Reco_QQ_size]
   ULong64_t       Reco_QQ_mumi_trig[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_isCowboy[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctau[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctauErr[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctau3D[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_ctauErr3D[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_VtxProb[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_dca[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_MassErr[30];   //[Reco_QQ_size]
   TClonesArray    *Reco_QQ_vtx;
   Int_t           Reco_QQ_Ntrk[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_SelectionType[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_SelectionType[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mupl_isGoodMuon[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mumi_isGoodMuon[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mupl_highPurity[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mumi_highPurity[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mupl_TrkMuArb[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mumi_TrkMuArb[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mupl_TMOneStaTight[30];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mumi_TMOneStaTight[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_nPixValHits[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_nPixValHits[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_nMuValHits[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_nMuValHits[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_nTrkHits[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_nTrkHits[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_normChi2_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_normChi2_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_normChi2_global[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_normChi2_global[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_nPixWMea[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_nPixWMea[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_nTrkWMea[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_nTrkWMea[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mupl_StationsMatched[30];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_StationsMatched[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_dxy[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_dxy[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_dxyErr[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_dxyErr[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_dz[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_dz[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_dzErr[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_dzErr[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_pt_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_pt_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_pt_global[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_pt_global[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_ptErr_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_ptErr_inner[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mupl_ptErr_global[30];   //[Reco_QQ_size]
   Float_t         Reco_QQ_mumi_ptErr_global[30];   //[Reco_QQ_size]
   Int_t           Reco_mu_size;
   Int_t           Reco_mu_type[10];   //[Reco_mu_size]
   Int_t           Reco_mu_SelectionType[10];   //[Reco_mu_size]
   Int_t           Reco_mu_charge[10];   //[Reco_mu_size]
   TClonesArray    *Reco_mu_4mom;
   ULong64_t       Reco_mu_trig[10];   //[Reco_mu_size]
   Bool_t          Reco_mu_isGoodMuon[10];   //[Reco_mu_size]
   Bool_t          Reco_mu_highPurity[10];   //[Reco_mu_size]
   Bool_t          Reco_mu_TrkMuArb[10];   //[Reco_mu_size]
   Bool_t          Reco_mu_TMOneStaTight[10];   //[Reco_mu_size]
   Int_t           Reco_mu_nPixValHits[10];   //[Reco_mu_size]
   Int_t           Reco_mu_nMuValHits[10];   //[Reco_mu_size]
   Int_t           Reco_mu_nTrkHits[10];   //[Reco_mu_size]
   Float_t         Reco_mu_normChi2_inner[10];   //[Reco_mu_size]
   Float_t         Reco_mu_normChi2_global[10];   //[Reco_mu_size]
   Int_t           Reco_mu_nPixWMea[10];   //[Reco_mu_size]
   Int_t           Reco_mu_nTrkWMea[10];   //[Reco_mu_size]
   Int_t           Reco_mu_StationsMatched[10];   //[Reco_mu_size]
   Float_t         Reco_mu_dxy[10];   //[Reco_mu_size]
   Float_t         Reco_mu_dxyErr[10];   //[Reco_mu_size]
   Float_t         Reco_mu_dz[10];   //[Reco_mu_size]
   Float_t         Reco_mu_dzErr[10];   //[Reco_mu_size]
   Float_t         Reco_mu_pt_inner[10];   //[Reco_mu_size]
   Float_t         Reco_mu_pt_global[10];   //[Reco_mu_size]
   Float_t         Reco_mu_ptErr_inner[10];   //[Reco_mu_size]
   Float_t         Reco_mu_ptErr_global[10];   //[Reco_mu_size]
   ...
   oniaEff_data(TTree *tree=0);
   virtual ~oniaEff_data();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(const char* fname_jpsi, const char* fname_psip, const char* fname_bkg, bool ispbpb=false);
...
#ifdef oniaEff_data_cxx
oniaEff_data::oniaEff_data(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/Data2015/PbPb502TeV/TTrees/PromptAOD/OniaTree_HIOniaL1DoubleMu0_HIRun2015-PromptReco-v1_Run_262620_263757.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/Data2015/PbPb502TeV/TTrees/PromptAOD/OniaTree_HIOniaL1DoubleMu0_HIRun2015-PromptReco-v1_Run_262620_263757.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.unl.edu//store/group/phys_heavyions/dileptons/Data2015/PbPb502TeV/TTrees/PromptAOD/OniaTree_HIOniaL1DoubleMu0_HIRun2015-PromptReco-v1_Run_262620_263757.root:/hionia");
...
oniaEff_data::~oniaEff_data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t oniaEff_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t oniaEff_data::LoadTree(Long64_t entry)
{
...
void oniaEff_data::Init(TTree *tree)
{
...
void oniaEff_data::Show(Long64_t entry)
{
...
Int_t oniaEff_data::Cut(Long64_t entry)
{
...
Bool_t oniaEff_data::isTriggerMatch (Int_t iRecoQQ, Int_t TriggerBit) 
{
   Bool_t cond = true;
...
Bool_t oniaEff_data::isGlobalMuonInAccept2015 (TLorentzVector* Muon) 
{
...
Bool_t oniaEff_data::areMuonsInAcceptance2015 (Int_t iRecoQQ)
{
...
Bool_t oniaEff_data::passQualityCuts2015 (Int_t iRecoQQ) 
{
   Bool_t cond = true;
