...
#ifndef oniaEff_DataVary_h
#define oniaEff_DataVary_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   oniaEff_DataVary(TTree *tree=0);
   virtual ~oniaEff_DataVary();
...
#ifdef oniaEff_DataVary_cxx
oniaEff_DataVary::oniaEff_DataVary(TTree *tree) : fChain(0) 
{
...
oniaEff_DataVary::~oniaEff_DataVary()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t oniaEff_DataVary::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t oniaEff_DataVary::LoadTree(Long64_t entry)
{
...
void oniaEff_DataVary::Init(TTree *tree)
{
...
Bool_t oniaEff_DataVary::Notify()
{
...
void oniaEff_DataVary::Show(Long64_t entry)
{
...
Int_t oniaEff_DataVary::Cut(Long64_t entry)
{
...
Bool_t oniaEff_DataVary::isTriggerMatch (Int_t iRecoQQ, Int_t TriggerBit) 
{
   Bool_t cond = true;
...
Bool_t oniaEff_DataVary::isGlobalMuonInAccept2015 (TLorentzVector* Muon) 
{
...
Bool_t oniaEff_DataVary::areMuonsInAcceptance2015 (Int_t iRecoQQ)
{
...
Bool_t oniaEff_DataVary::passQualityCuts2015 (Int_t iRecoQQ) 
{
   Bool_t cond = true;
...
#endif // #ifdef oniaEff_DataVary_cxx
